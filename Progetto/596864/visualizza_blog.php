        ...
        <div class="container">
            ...
            <script>
                ...
                document.getElementById('save-title_blog-btn').addEventListener('click', function() {
                    var newTitleBlog = document.getElementById('new_title_blog').value.trim(); // Remove leading and trailing whitespaces
                    if (newTitleBlog === '') {
                ...
                document.getElementById('save-description_blog-btn').addEventListener('click', function() {
                    var newDescriptionBlog = document.getElementById('new_description_blog').value.trim(); // Remove leading and trailing whitespaces
                ...
                document.getElementById('cancel-title_blog-btn').addEventListener('click', function() {
                    ...
                    document.getElementById('new_title_blog').value = '<?php echo $titolo_blog; ?>'; // Restore original value
                });
                ...
                document.getElementById('cancel-description_blog-btn').addEventListener('click', function() {
                    ...
                    document.getElementById('new_description_blog').value = '<?php echo $descrizione; ?>'; // Restore original value
                });

...
$select_query_seguaci = "SELECT Username, FotoProfilo 
                         FROM Utente 
                         JOIN FollowUtente 
                         ON Utente.IdUtente = FollowUtente.IdUtenteSeguace 
                         WHERE IdUtenteSeguito = $id_utente 
                         AND IdUtenteSeguace <> $id_utente 
                         LIMIT $itemsPerPage OFFSET $offset";
$result = $mysqli->query($select_query_seguaci);
...
<head>
    ...
    <title>LoDicoDaSeguaci</title>
    <link rel="stylesheet" href="style/style.css">
    <link rel="stylesheet" href="style/style_seguaci.css">
